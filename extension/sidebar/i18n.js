...
export const translations = {
  ml: {
    ...
    matchesText: 'പൊരുത്തങ്ങൾ (ആകെ വാക്കുകൾ)',
    ...
    // Multi-Area Selection in Translate
    selectAreaTitle: 'പരിഭാഷപ്പെടുത്തേണ്ട ഭാഗം:',
    areasDetected: 'ഭാഗങ്ങൾ കണ്ടെത്തി',
    showAreaOnPage: '👉 പേജിൽ കാണിക്കുക',
    wholePageOption: '🌐 മുഴുവൻ പേജ്',
    areaPreviewLabel: 'തിരഞ്ഞെടുത്ത ഭാഗം:',
    translatedAreaLabel: 'തർജ്ജമ ചെയ്ത ഭാഗം:',
    areaSpotlightActive: '📍 പേജിൽ കാണിച്ചിരിക്കുന്നു',
    ...
    // User Manual & Usability Guide Strings
    manualTabBtn: '📖 ഉപയോക്തൃ സഹായി & ഗൈഡ്',
    liveScanTabBtn: '🔍 തത്സമയ വെബ്‌പേജ് സ്കാൻ',
    manualMainTitle: 'തുണ (Thunai) - ഉപയോക്തൃ സഹായി',
    manualMainSub: 'ബ്രൗസർ എക്സ്റ്റൻഷന്റെ ലക്ഷ്യവും ഓരോ ഫീച്ചറിന്റെയും പ്രവർത്തന രീതിയും',
    purposeHeading: 'എക്സ്റ്റൻഷന്റെ ലക്ഷ്യം (Purpose & Mission)',
    purposeDesc: 'സാധാരണക്കാർക്കും, മുതിർന്ന പൗരന്മാർക്കും, ഡിസ്‌ലെക്സിയ (Dyslexia) അല്ലെങ്കിൽ കാഴ്ചാ വൈകല്യമുള്ളവർക്കും, മലയാളം സംസാരിക്കുന്നവർക്കും ഇന്റർനെറ്റിലെ ഏത് വെബ്‌സൈറ്റും ലളിതമായും തടസ്സങ്ങളില്ലാതെയും ഉപയോഗിക്കാൻ സഹായിക്കുന്ന സമ്പൂർണ്ണ ഡിജിറ്റൽ പ്രവേശനക്ഷമതാ (Accessibility) സഹായിയാണ് തുണ (Thunai).',
    purposePillar1Title: 'ഭാഷാ തടസ്സങ്ങൾ ഇല്ലാതാക്കുന്നു',
    purposePillar1Desc: 'ഇംഗ്ലീഷിലോ ഹിന്ദിയിലോ ഉള്ള സങ്കീർണ്ണമായ സർക്കാർ/വിദ്യാഭ്യാസ വെബ്‌സൈറ്റുകൾ ലളിതമായ മലയാളത്തിലേക്ക് തർജ്ജമ ചെയ്യുകയും ചുരുക്കി നൽകുകയും ചെയ്യുന്നു.',
    purposePillar2Title: 'വായനാ വൈകല്യങ്ങൾക്ക് പരിഹാരം',
    purposePillar2Desc: 'ഡിസ്‌ലെക്സിയ സൗഹൃദ ഫോണ്ടുകൾ, കളർ ടിന്റുകൾ, റീഡിംഗ് റൂളർ എന്നിവയിലൂടെ അക്ഷരങ്ങൾ മറിയുന്നതും വായനാ ആയാസവും ഇല്ലാതാക്കുന്നു.',
    purposePillar3Title: 'തത്സമയ ഓഡിയോ വായന',
    purposePillar3Desc: 'വെബ്‌പേജ് വരികൾ നേരിട്ട് കാണിച്ചുതന്നുകൊണ്ട് സ്വാഭാവിക മലയാള ശബ്ദത്തിൽ വായിച്ചു കേൾപ്പിക്കുന്നു.',
    purposePillar4Title: 'വെബ്‌സൈറ്റ് തകരാറുകൾ പരിഹരിക്കുന്നു',
    purposePillar4Desc: 'WCAG 2.1 AA മാനദണ്ഡങ്ങൾ പരിശോധിച്ച് ക്ലിക്ക് ചെയ്യാനാകാത്ത ബട്ടണുകളും ഫോമുകളും AI സഹായത്തോടെ സ്വയം ശരിയാക്കുന്നു.',
    ...
    featScanPurpose: 'വെബ്‌പേജിലെ കാഴ്ചാ തടസ്സങ്ങൾ, കുറഞ്ഞ കളർ കോൺട്രാസ്റ്റ്, ചിത്രങ്ങളുടെ വിവരണമില്ലായ്മ (Alt Text), തകരാറിലായ ലിങ്കുകൾ എന്നിവ കണ്ടെത്തുന്നു.',
    ...
    refreshTooltip: 'ഈ ഫീച്ചറിന്റെ പ്രാരംഭാവസ്ഥയിലേക്ക് റീഫ്രഷ് ചെയ്യുക',
    refreshAllTooltip: 'എല്ലാ മാറ്റങ്ങളും മാറ്റി പേജ് പ്രാരംഭാവസ്ഥയിലേക്ക് റീഫ്രഷ് ചെയ്യുക',
  ...
  en: {
    ...
    searchTitle: 'Find in Page (Keyword Finder)',
    searchSub: 'Search & highlight all occurrences of any word on the active page',
    searchFound: 'Found:',
    matchesText: 'total occurrences',
    totalOccurrences: 'Total occurrences on webpage:',
    noMatches: 'No content containing this word was found on the webpage.',
    searchHint: 'Type a word to search (e.g. application, fee, login, date, photo)',
    listenMatch: 'Listen',
    ...
    // Multi-Area Selection in Translate
    selectAreaTitle: 'Select Area to Translate:',
    areasDetected: 'content areas detected',
    showAreaOnPage: '👉 Show on Page',
    wholePageOption: '🌐 Whole Webpage',
    areaPreviewLabel: 'Area Preview:',
    ...
    featSearchHow: 'Type any keyword in the search bar. Thunai displays the total occurrences found across the webpage. Click "👉 Point on Page" on any match to cast an animated spotlight pointer directly at that exact element on the live webpage.',
    ...
    featListenHow: 'Press Play to begin. Each sentence is highlighted on the live webpage in sync with the audio. Adjust playback speed from 0.5x to 2.0x and navigate segments with Previous/Next controls.',
    ...
    featTranslateHow: 'Click "Translate to Malayalam". If the text is too dense, switch on the "Simplify Language" toggle to get a simplified version. Listen or copy with 1 click.',
    ...
    featDiagHow: 'Click "Inspect Specific Button" or "Pick on Page" and click any problematic button. Thunai diagnoses the root cause in plain language, provides 1-click auto-fixes, audits all page buttons, or lets you ask the AI assistant.',

    // Refresh Actions
    refreshBtn: 'Refresh (Fresh State)',
    refreshFeatureBtn: 'Reset to Fresh State',
    refreshTooltip: 'Reset this feature back to its fresh initial state',
    refreshAllTooltip: 'Reset all active webpage overlays back to clean state',
